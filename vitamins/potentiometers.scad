...
metric_pot_Qshaft = ["metric_pot_Qshaft",[23,     11,   1.0], [0, 15.33, 0.8],   [18, 27, 1.2, false], 1,   10,        0.75,       7.32, 13.9, 2.5, [1.12, 2.88, 1.26], 11, [6.27, 1.0, 43.8, 43.5, grey(50)], [0, 0],  [12.8, 2,   silver], [17.7, 0.8, grey(20), 10]];
...
potentiometers = [BTT_encoder, KY_040_encoder, metric_pot_Qshaft, metric_pot, imperial_pot, imperial_pot_x2];
